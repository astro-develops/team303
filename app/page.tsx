...
export default function Home() {
    return (
        <main className="bg-[#DBE9EE] text-[#0C2B2C] m-0 p-0 overflow-x-hidden">
            ...
            <section className="min-h-screen flex flex-col justify-center items-center px-6 md:px-0">
            ...
            <section
                className="min-h-[70vh] bg-fixed bg-no-repeat bg-cover bg-center relative text-white p-0"
            ...
            >
                ...
                <svg
                    ...
                    className="absolute bottom-0 left-0 w-full block h-12 lg:h-20"
                >
                    <path d="M0.492188 77.141L1439.31 0.867188V77.141H0.492188Z" fill="#DBE9EE" />
                </svg>
            </section>

            <section className="min-h-screen bg-[#DBE9EE] flex flex-col justify-center items-center text-white text-center py-20 lg:py-0 lg:-mt-[12rem] lg:-mb-[8rem]">
                <Image src="/text/OurSponsors.svg" alt="" width={400} height={100} className="-rotate-[3.5deg] p-6 mb-4 w-full max-w-[400px]" />
            ...
            <section
                className="min-h-[70vh] flex flex-col justify-center bg-fixed bg-no-repeat bg-cover bg-center relative text-white p-0"
            ...
            >
                ...
                <svg
                    ...
                    preserveAspectRatio="none"
                    xmlns="http://www.w3.org/2000/svg"
                    className="absolute top-0 left-0 w-full block h-12 lg:h-20"
                >
